          ...
          <div class="user-wrp saleextutive mt-3 ">
                ...
                <table id="example" class="table table-striped table-bordered" >
                  <thead>
                    <tr>
                      ...
                      <th> <a href="<?=$ADMIN->iurl($comp)?>&fld=deptId<?=(($otype=='asc')?"&otype=desc":'&otype=asc')?>" <?=(($fld=='deptId')?'class="selectedTab"':'')?>><span <?=(($otype=='asc')?'class="des"':'class="asc"')?>>Depratment</span></a> </th>
			...
			?>
                    <tr>
                      ...
                      <td><?=$nums?></td>
                      <td><?=$name?></td>
                      <td><?=$PDO->getsingleresult("select name from #_department where pid='".$deptId."'")?> </td>
