...
<section class="ptb50 sectionbg">
  ...
  <div class="row">
    ...
    <div class="row">
      <?php    $compRy =$PDO->db_query("select * from #_product_manager where status=1 and dpid IN('6','7')"); 
			...
			//echo "select count(*) from #_leads where service IN($serviceids) and payment=1 and processStatus=0";
			 ?>
    <div class="col">
        <div class="info-box"> <span class="info-box-icon bg-green"><i class="ion ion-ios-gear-outline"></i></span>
          <div class="info-box-content "> <span class="info-box-number"><?=$PDO->getSingleresult("select count(*) from #_leads where service IN($serviceids) and payment=1 and processStatus=0 and deid='".$_SESSION["AMD"][0]."'");?></span> <span class="info-box-text">New</span> </div>
          <!-- /.info-box-content --> 
        </div>
        <!-- /.info-box --> 
      </div>
      <div class="col">
        <div class="info-box"> <span class="info-box-icon bg-aqua"><i class="ion ion-ios-gear-outline"></i></span>
          <div class="info-box-content "> <span class="info-box-number"><?=$PDO->getSingleresult("select count(*) from #_leads where service IN($serviceids) and payment=1 and processStatus=13 and deid='".$_SESSION["AMD"][0]."'");?></span> <span class="info-box-text">Basic Doc</span> </div>
          <!-- /.info-box-content --> 
        </div>
        <!-- /.info-box --> 
      </div>
      ...
      <div class="col">
        <div class="info-box"> <span class="info-box-icon bg-red"> </span>
          <div class="info-box-content"> <span class="info-box-number"><?=$PDO->getSingleresult("select count(*) from #_leads where service IN($serviceids) and payment=1 and processStatus=14 and deid='".$_SESSION["AMD"][0]."'" );?></span> <span class="info-box-text">Pending Doc</span> </div>
          <!-- /.info-box-content --> 
        </div>
        <!-- /.info-box --> 
      </div>
      ...
      <div class="col">
        <div class="info-box"> <span class="info-box-icon bg-green"><i class="ion ion-ios-cart-outline"></i></span>
          <div class="info-box-content"> <span class="info-box-number"><?=$PDO->getSingleresult("select count(*) from #_leads where service IN($serviceids) and payment=1 and processStatus=15 and deid='".$_SESSION["AMD"][0]."'");?></span> <span class="info-box-text">Form Submitted</span> </div>
          <!-- /.info-box-content --> 
        </div>
        <!-- /.info-box --> 
      </div>
      ...
      <div class="col">
        <div class="info-box"> <span class="info-box-icon bg-yellow"><i class="ion ion-ios-people-outline"></i></span>
          <div class="info-box-content"> <span class="info-box-number"><?=$PDO->getSingleresult("select count(*) from #_leads where service IN($serviceids) and payment=1 and processStatus=16 and deid='".$_SESSION["AMD"][0]."'");?></span> <span class="info-box-text">Work Complete</span> </div>
          <!-- /.info-box-content --> 
        </div>
        <!-- /.info-box --> 
      </div>
...
<section class="mtb50">
  <div class="container ">
	...
	while (strtotime($date2) <= strtotime($end_date2)) {
		...
		if($a2==5){$comma2='';}
$leadarr2=array( "name" => date('jS \ M y', strtotime($date2)),"y" =>$PDO->getSingleresult("select count(*) from #_leads where service IN($serviceids) and date(paymentDate)='".$date2."' and deid='".$_SESSION["AMD"][0]."'"),"drilldown" =>date('jS \ M y', strtotime($date2)));
...
Highcharts.chart('DailyLead', {
    ...
    series: [{
        ...
        <?php 
		   $sourcery =$PDO->db_query("select * from #_product_manager where status=1 and dpid=6"); 
		 ...
		 $scnt2=$PDO->getSingleresult("select count(*) from #_leads where service='".$sourceRs['pid']."' and payment=1 and deid='".$_SESSION["AMD"][0]."'");
