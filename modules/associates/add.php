              ...
              <div class="row">
                <div class="col">
                  <div class="form-group">
					  ...
					  <select class="validate[required] form-control" name="occupation">
							   <option value="">Select Occupation</option>
                        <option value="Charter Accountant"  <?=($occupation=='Charter Accountant')?'selected="selected"':''?>>Chartered Accountant</option>
                        <option value="Company Secretary" <?=($occupation=='Company Secretary')?'selected="selected"':''?>>Company Secretary</option>
                        <option value="Lawyer" <?=($occupation=='Lawyer')?'selected="selected"':''?>>Lawyer</option>
                        <option value="Business Consultant" <?=($occupation=='Business Consultant')?'selected="selected"':''?>>Business Consultant</option>
                        <option value="CWA" <?=($occupation=='CWA')?'selected="selected"':''?>>CWA</option>
                        <option value="Sales Partner" <?=($occupation=='Sales Partner')?'selected="selected"':''?>>Sales Partner</option>
                        <option value="Others" <?=($occupation=='Others')?'selected="selected"':''?>>Others</option>
					  </select>
					</div>
                </div>
                <div class="col">
