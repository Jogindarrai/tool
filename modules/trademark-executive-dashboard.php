    ...
    <div class="col">
      ...
      <div class="col">
        <div class="info-box"> <span class="info-box-icon bg-aqua"><i class="ion ion-ios-gear-outline"></i></span>
          <div class="info-box-content "> <span class="info-box-number"><?=$PDO->getSingleresult("select count(*) from #_leads where service IN($serviceids) and payment=1 and processStatus=9 and deid='".$_SESSION["AMD"][0]."'");?></span> <span class="info-box-text">Basic Info</span> </div>
          <!-- /.info-box-content --> 
        </div>
        <!-- /.info-box --> 
      </div>
      ...
      <div class="col">
        <div class="info-box"> <span class="info-box-icon bg-red"> </span>
          <div class="info-box-content"> <span class="info-box-number"><?=$PDO->getSingleresult("select count(*) from #_leads where service IN($serviceids) and payment=1 and processStatus=10 and deid='".$_SESSION["AMD"][0]."'");?></span> <span class="info-box-text">Application Drafted</span> </div>
          <!-- /.info-box-content --> 
        </div>
        <!-- /.info-box --> 
      </div>
      ...
      <div class="col">
        <div class="info-box"> <span class="info-box-icon bg-green"><i class="ion ion-ios-cart-outline"></i></span>
          <div class="info-box-content"> <span class="info-box-number"><?=$PDO->getSingleresult("select count(*) from #_leads where service IN($serviceids) and payment=1 and processStatus=11 and deid='".$_SESSION["AMD"][0]."'");?></span> <span class="info-box-text">Approval on Draft</span> </div>
          <!-- /.info-box-content --> 
        </div>
        <!-- /.info-box --> 
      </div>
      ...
      <div class="col">
        <div class="info-box"> <span class="info-box-icon bg-yellow"><i class="ion ion-ios-people-outline"></i></span>
          <div class="info-box-content"> <span class="info-box-number"><?=$PDO->getSingleresult("select count(*) from #_leads where service IN($serviceids) and payment=1 and processStatus=12 and deid='".$_SESSION["AMD"][0]."'");?></span> <span class="info-box-text">Application Submitted</span> </div>
          <!-- /.info-box-content --> 
        </div>
        <!-- /.info-box --> 
      </div>
