    ...
    <div class="col">
      ...
      <div class="col">
        <div class="info-box"> <span class="info-box-icon bg-aqua"><i class="ion ion-ios-gear-outline"></i></span>
          <div class="info-box-content ">
           <a href="<?=$ADMIN->iurl('leads')?>&work_process=13<?=$adminaccess?>">
           <span class="info-box-number"><?=$PDO->getSingleresult("select count(*) from #_leads where service IN($serviceids) and payment=1 and processStatus=13");?></span> <span class="info-box-text">Basic Doc</span></a> </div>
          <!-- /.info-box-content --> 
        </div>
        <!-- /.info-box --> 
      </div>
      ...
      <div class="col">
        <div class="info-box"> <span class="info-box-icon bg-red"> </span>
          <div class="info-box-content">
           <a href="<?=$ADMIN->iurl('leads')?>&work_process=14<?=$adminaccess?>">
           <span class="info-box-number"><?=$PDO->getSingleresult("select count(*) from #_leads where service IN($serviceids) and payment=1 and processStatus=14");?></span> <span class="info-box-text">Pending Doc</span></a> </div>
          <!-- /.info-box-content --> 
        </div>
        <!-- /.info-box --> 
      </div>
      ...
      <div class="col">
        <div class="info-box"> <span class="info-box-icon bg-green"><i class="ion ion-ios-cart-outline"></i></span>
          <div class="info-box-content">
           <a href="<?=$ADMIN->iurl('leads')?>&work_process=15<?=$adminaccess?>">
           <span class="info-box-number"><?=$PDO->getSingleresult("select count(*) from #_leads where service IN($serviceids) and payment=1 and processStatus=15");?></span> <span class="info-box-text">Form Submitted</span></a> </div>
          <!-- /.info-box-content --> 
        </div>
        <!-- /.info-box --> 
      </div>
      ...
      <div class="col">
        <div class="info-box"> <span class="info-box-icon bg-yellow"><i class="ion ion-ios-people-outline"></i></span>
          <div class="info-box-content">
           <a href="<?=$ADMIN->iurl('leads')?>&work_process=16<?=$adminaccess?>">
           <span class="info-box-number"><?=$PDO->getSingleresult("select count(*) from #_leads where service IN($serviceids) and payment=1 and processStatus=16");?></span> <span class="info-box-text">Work Complete</span></a> </div>
          <!-- /.info-box-content --> 
        </div>
        <!-- /.info-box --> 
      </div>
