              ...
              <div class="row">
                ...
                <div class="col-12 col-md-6">
                  <div class="form-group">
                   ...
                   <select name="ltype"  class="validate[required] form-control" data-errormessage-value-missing="Lead Type is required!">
            <option  value="">-------Select Lead Type------</option>
            <option value="Organic" <?=($ltype=='Organic')?'selected="selected"':''?>  >Organic</option>
            <option value="Paid" <?=($ltype=='Paid')?'selected="selected"':''?>>Paid</option>
            <option value="Referral" <?=($ltype=='Referral')?'selected="selected"':''?>  >Referral</option>
            <option value="Alliance" <?=($ltype=='Alliance')?'selected="selected"':''?> >Alliance</option>
          </select>
                  </div>
                </div>
              </div>
