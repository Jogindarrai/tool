...
class Pages extends dbc
{
	  ...
	  public function assign($updateid,$salesecutiveid,$colname)
	 {
		   ...
		   if(is_array($updateid))
		   {
			   $updateid=str_replace("TMI","",implode(',',$updateid));
		   }
	  ...
	  public function  display($start,$pagesize,$fld,$otype,$search_data,$extra,$extra1,$extra2)
	 {
		...
		if(trim($search_data)!='')
		{
		   $wh=" and (name like '%".$search_data."%' or email like '%".$search_data."%' or rwi like '%".$search_data."%' or phone like '%".$search_data."%'or dates like '%".$search_data."%') ";	
		}
