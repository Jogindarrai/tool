...
include(FS_ADMIN . _MODS . "/invoice2023_24/invoice2023_24.inc.php");
...
if ($RW->is_post_back()) {
    ...
    if ($flag[0] == 1 || $flag == 1) {
        ...
        if ($uid) {
            ...
            $RW->redir($ADMIN->iurl($comp . ('&mode=invoice2021_22') . ('&uid=' . $uid) . (($raid) ? '&raid=' . $raid : '')), true);

        } else {



            $RW->redir($ADMIN->iurl($comp . ('&mode=invoice2021_22') . ('&uid=' . $inid) . (($raid) ? '&raid=' . $raid : '')), true);
        ...
        <div class="tbl-contant">
            ...
            <div class="section last">
                ...
                <div class="invicewarp">
                    ...
                    <div class="header" style="width: 25%; float:right;  margin-top: 10px; margin-bottom:6px; text-align:right;"> <img src="<?= SITE_PATH_ADM . _MODS . '/' . $comp ?>/images/rwlogo.png" /> </div>
                    ...
                    <div class="invicecon">
                        ...
                        <table border="1" cellspacing="0" cellpadding="0" width="100%" class="firsttable">
                            ...
                            <tr>
                                ...
                                <td width="43%" valign="top"><p><strong> BLUE INKK</strong><br />
                                        ...
                                        <strong>PAN:</strong> AAVFB5292Q

                                        <input type="hidden" name="pan" value="AAVFB5292Q" />

                                        <br />

                                        <strong>GST Identification Number:</strong> 07AAVFB5292Q1ZF

                                        <input type="hidden" name="servicetaxno" value="07AAVFB5292Q1ZF" />
                                        ...
                                        <?= $inviceno ? $inviceno : "BI/" . date('Y') . '-' . date('y', strtotime('+1 year')) . "/000" ?>
                        ...
                        <!--             <input type="text" class="validate[required,funcCall[ValidateDate]]" id="datetimepicker" name="invicedate" value="<?= $invicedate ? $invicedate : date("Y-m-d h:m:s") ?>"/>
                                        ...
                                        <input class="validate[required] txt medium" type="text" name="rlmanager" value="<?= $rlmanager ? $rlmanager : $_SESSION["AMD"][1] ?>" placeholder="Mayank Goel" />
                    ...
                    <div class="invicecon">
                        ...
                        <table border="1" cellspacing="0" cellpadding="0" width="100%" class="stable">
                            ...
                            <tr class="reverse-charge" style="display:none;">
                                ...
                                <td width="85%" valign="top" colspan="2"><p align="left">Supply of Services liable to Reverse Charge</p></td>
                    ...
                    <div class="invicecon foot">
                        ...
                        <p><strong>"BLUE INKK"</strong></p>

                        <p><strong>INDUSIND BANK</strong> (Current A/C)<br />

                            BRANCH - <strong>  Barakhamba,  </strong><strong> New Delhi-110001</strong><br />

                            ACCOUNT NO. - <strong>201003826554, </strong>IFSC  Code -<strong>INDB0000005</strong></p>
                    ...
                    <div class="footer1"> E - 1070 GROUND FLOOR SARASWATI VIHAR,



                        PITAMPURA, DELHI-110034<br />

                        <strong>Mobile:</strong>+91 9958-000-637

                        <strong>E-mail:</strong> mayank@blueinkk.com </div>
...
//console.log(grt);
    ...
    function servicelist(el) {
        ...
        $.ajax({
            ...
            url: '<?= SITE_PATH_ADM . _MODS . '/invoice2021_22/' ?>ajax_refresh.php',
