<?php 
include(FS_ADMIN._MODS."/service_manager/service_manager.inc.php");
                ...
                <table id="example" class="table table-striped table-bordered" >
                  <thead>
                    <tr>
                      ...
                      <th>SL No</th>
                      <th> <a href="<?=$ADMIN->iurl($comp)?>&fld=name<?=(($otype=='asc')?"&otype=desc":'&otype=asc')?>" <?=(($fld=='name')?'class="selectedTab"':'')?>><span <?=(($otype=='asc')?'class="des"':'class="asc"')?>> Name of Service</span></a> </th>
                   <!--   <th><a href="<?=$ADMIN->iurl($comp)?>&fld=price<?=(($otype=='asc')?"&otype=desc":'&otype=asc')?>" <?=(($fld=='price')?'class="selectedTab"':'')?>><span <?=(($otype=='asc')?'class="des"':'class="asc"')?>> Price</span></a> </th>
                      <th><a href="<?=$ADMIN->iurl($comp)?>&fld=sacCode<?=(($otype=='asc')?"&otype=desc":'&otype=asc')?>" <?=(($fld=='sacCode')?'class="selectedTab"':'')?>><span <?=(($otype=='asc')?'class="des"':'class="asc"')?>> SAC/HSN </span></a></th>
                      <th><a href="<?=$ADMIN->iurl($comp)?>&fld=tax<?=(($otype=='asc')?"&otype=desc":'&otype=asc')?>" <?=(($fld=='tax')?'class="selectedTab"':'')?>><span <?=(($otype=='asc')?'class="des"':'class="asc"')?>> Tax</span></a></th>
