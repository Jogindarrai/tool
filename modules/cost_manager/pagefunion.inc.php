...
class Pages extends dbc
{
	 ...
	 public function  add($data)
	 {
	        ...
	        if($query->rowCount()==0)
	        {
				...
				$lastinsid=parent::sqlquery("rs",tblName,$data);
		        parent::sessset('Record has been added', 's');
				$flag['flag']=1;
				$flag['lastinsid']=$lastinsid;
		    }else {
	 ...
	 public function  update($data)
	 {
	       ...
	       if($query->rowCount()==0)
	       {
			     ...
			     $lastinsid=parent::sqlquery("rs",tblName,$data,'pid',$updateid);
	 ...
	 public function  display($start,$pagesize,$fld,$otype,$search_data,$zone,$mtype,$extra,$extra1,$extra2)
	 {
		...
		if(trim($search_data)!='')
		{
		   $wh=" and (name like '%".$search_data."%' or url like '%".$search_data."%') ";	
		}
