...
function delimg(path, image){
	if(confirm("Do yuo want to delete this image?")){
		location.href=path + '&del_img=' + image;
	} else {
		return false;  
	}
}
...
function ptypestatus(a){
	if(a=='Cheque'){
		document.getElementById('chqqpo').lang='R';	
		document.getElementById('chqs').style.display='block';
		document.getElementById('poo').style.display='none';
	} else if(a=='CC'){
		document.getElementById('chqqpo').lang='';	
		document.getElementById('chqs').style.display='none';
		document.getElementById('poo').style.display='none';
	} else {
		document.getElementById('chqqpo').lang='';	
		document.getElementById('chqs').style.display='none';
...
function searchf(url, com){
	document.aforms.method = 'POST';	
	document.aforms.action = url + "components/filter.php?compname=" + com;
	document.aforms.submit();
}
function searchf1(url, com, mod){
	document.aforms.method = 'POST';
	document.aforms.action = url + "components/filter.php?compname=" + com +"&mode="+mod;
	document.aforms.submit();
}
function popups400(idsa, tags){
	if(tags=='off'){
		document.getElementById(idsa).className='popup400';	
	} else{
		document.getElementById(idsa).className='popup401';		
	}
}
function popups(idsa, tags){
	if(tags=='off'){
		document.getElementById(idsa).className='popup555';	
	} else{
		document.getElementById(idsa).className='popup666';		
	}
}
function popups4(idsa, tags){
	if(tags=='off'){
		document.getElementById(idsa).className='popup444';	
	} else{
		document.getElementById(idsa).className='popup888';		
	}
}
function popups44(idsa, tags){
	if(tags=='off'){
		document.getElementById(idsa).className='popup501';	
	} else{
		document.getElementById(idsa).className='popup502';		
	}
}
function popups444(idsa, tags){
	if(tags=='off'){
		document.getElementById(idsa).className='popup503';	
	} else{
		document.getElementById(idsa).className='popup504';		
	}
}
function featured(fvalues){
	if(fvalues=='yes'){
		document.getElementById("fstyle").style.display='block';
		document.getElementById("fcatname").lang='R';
	} else{
		document.getElementById("fstyle").style.display='none';
			document.getElementById("fcatname").lang='';
	}
}
function catchange(fvalues){
	if(!fvalues){	
		document.getElementById("childid").value='0';
		document.getElementById("cidcheck").value='yes';
	} else{
		document.getElementById("cidcheck").value='no';
	}
}
function adds2_(){
	if(document.getElementById('adds22').checked==true){
		document.getElementById('vsname').value = document.getElementById('vname').value;
		document.getElementById('vsadd1').value = document.getElementById('vadd1').value;
		document.getElementById('vsadd2').value = document.getElementById('vadd2').value;
		...
		document.getElementById('vszip').value = document.getElementById('vzip').value;
		document.getElementById('vsphone').value = document.getElementById('vphone').value;
		document.getElementById('vsemail').value = document.getElementById('vemail').value;
	} else{
		document.getElementById('vsname').value = "";
		document.getElementById('vsadd1').value = "";
		document.getElementById('vsadd2').value = "";
		document.getElementById('vscity').value = "";
		document.getElementById('vsstate').value = "";
		document.getElementById('vszip').value = "";
		document.getElementById('vsphone').value = "";
		document.getElementById('vsemail').value = "";
	}
}
function checkstate(vals){
	if(vals=='admin' || vals=='editor'){
		document.getElementById("stateid").lang='';
		document.getElementById('stateid').disabled=true;
	} else{
		document.getElementById("stateid").lang='R';
