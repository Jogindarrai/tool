...
public function sqlquerywithPrefix($tablename, $arr, $rs = "exe", $update = "", $id = "", $update2 = "", $id2 = "")
{
    ...
    // 🚑 SAFE GUARD: empty ya invalid data aaye to simply stop
    ...
    while ($row = $sql->fetch()) {
        ...
        if (array_key_exists($field, $arr)) {
            ...
            // array value ko string bana do (checkbox case)
    ...
    // 🚑 AGAR KOI VALID COLUMN NA MILE → QUERY RUN HI MAT KARO
    if (empty($columns)) {
        return false;
    }
